...
namespace M.OracleHelper
{
    public class OracleHelper
    {
        /// <summary>
        /// 注：在.net中sql语法 SQL语句结尾不能用分号，否则报错：ORA-00911：无效字符
        /// 错误写法：string sql = "SELECT * FROM TB_USERS;";
        /// 正确写法：string sql = "SELECT * FROM TB_USERS";
        /// </summary>
        ...
        //public int GetRecordCount(string sql) 我注释
        //{
        //    int  recordCount = 0;
        //    OpenConn();
        //    OracleCommand command = new OracleCommand(sql, Connection);
